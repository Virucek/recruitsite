...
urlpatterns = [
    ...
    path('resume/<int:pk>/experience', views.ResumeExperienceCreateView.as_view(), name='resume_experience'),
    ...
    path('resume/<int:pk>/education', views.ResumeEducationCreateView.as_view(), name='resume_education'),
