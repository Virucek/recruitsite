...
class Employer(models.Model):
    ...
    tax_number = models.IntegerField(verbose_name='ИНН компании', blank=True)
    phone_number = models.IntegerField(verbose_name='телефон', blank=True)
    site = models.CharField(verbose_name='сайт компании', max_length=32, blank=True)
    industry_type = models.CharField(verbose_name='тип отрасли компании', max_length=32)
